...
const {
  signinRoute,
  signupRoute,
} = require('./routes/v1/authentication.route');
...
app
  ...
  .get(`${BaseRouteV1}`, (req, res) => {
    res
      .status(200)
      .end(
        "Blogging API Version 1, please make req to the /signin route to login or /signup if you don't have an account. explore the /posts to get blog article. Check out API documentation at https://github.com/St-Pardon/blogging-api/blob/master/routes/v1/README.md for more routes Thank you!"
      );
  })
  .get(`${BaseRouteV2}`, (req, res) => {
    res.status(200).end('Blogging API Version 2, comming soon Thank you!');
  })
